...
const WhoPage: React.FC<WhoPageProps> = () => {
  const socials = [
    {
      icon: <TwitterSvg className="appLg:w-[50px] appLg:h-[50px] w-[28px] h-[28px]" />,
      href: "",
      name: "twitter"
    },
    {
      icon: <LinkedinSvg className="appLg:w-[50px] appLg:h-[50px] w-[28px] h-[28px]" />,
      href: "",
      name: "linkedin"
    },
    {
      icon: <InstagramSvg className="appLg:w-[50px] appLg:h-[50px] w-[28px] h-[28px]" />,
      href: "",
      name: "instagram"
    },
    {
      icon: <YoutubeSvg className="appLg:w-[50px] appLg:h-[50px] w-[28px] h-[28px]" />,
      href: "",
      name: "youtube"
    },
    {
      icon: <FacebookSvg className="appLg:w-[50px] appLg:h-[50px] w-[28px] h-[28px]" />,
      href: "",
      name: "facebook"
    },
  ]
  return (<section id="who" className="bg-[#EEEEEE] h-screen relative z-10 overflow-x-clip">
    ...
    <SectionLayout>
      <div className="relative z-0 flex appLg:flex-row flex-col items-center appLg:justify-end justify-center h-full gap-x-[72.37px]">
        <div className="w-[231.63px] h-[410px] appLg:w-[391.97px] appLg:h-[571.49px] relative">
        ...
        <div className="w-[288px] appMd:w-[505px] appLg:space-y-[16px]">
          <div className="">
            <p className="font-philosopher font-bold text-[44px] appMd:text-[78px] text-[#121212]">Ambracadabra</p>
            <p className="font-philosopher font-bold text-[50px] appMd:text-[88px] text-[#121212]">Your <span className="text-[#CD986D]">Desires</span></p>
            <p className="mt-[16px] font-montserrat text-[#121212] font-normal text-[12px] leading-[24px] appLg:text-[16px] appLg:leading-[32px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore Lorem ipsum dolor sit amet</p>
          </div>
