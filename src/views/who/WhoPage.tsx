...
const WhoPage: React.FC<WhoPageProps> = () => {
  ...
  return (<section id="who" className="bg-[#EEEEEE] h-screen relative z-10 overflow-x-clip">
    ...
    <SectionLayout>
      <div className="relative z-0 flex items-center justify-end h-full gap-x-[72.37px]">
        <div className="w-[391.97px] h-[571.49px] relative">
          <Image className="w-[180px] h-auto absolute top-0 right-[32px] rotate-[-35deg]" src="/images/who-card-1.png" width={230} height={324.98} alt="" />
          <Image className="w-[180px] h-auto absolute bottom-[109px] left-0 rotate-[35deg]" src="/images/who-card-2.png" width={230} height={324.98} alt="" />
          <Image className="w-[180px] h-auto absolute right-0 bottom-0 rotate-[345deg]" src="/images/who-card-3.png" width={230} height={324.98} alt="" />
        </div>
        <div className="w-[505px] space-y-[16px]">
          <div className="">
            <p className="font-philosopher font-bold text-[78px] text-[#121212]">Ambracadabra</p>
            <p className="font-philosopher font-bold text-[88px] text-[#121212]">Your <span className="text-[#CD986D]">Desires</span></p>
            <p className="mt-[16px] font-montserrat text-[#121212] font-normal text-[16px] leading-[32px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore Lorem ipsum dolor sit amet</p>
          </div>
